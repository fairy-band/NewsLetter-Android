...
class NewsRepositoryImpl : NewsRepository {
    private val _news = listOf(
        ...
        NewsResponse(id = "4", title = "잭슨 피자를 시키려고 했으나 38800원이라 노모어 피자로 도망 간 슬픈 이야기. 여름이었다.", keyword = "Kotlin", letter = "Android Weekly", summary = "", url = "https://www.naver.com"),
        ...
        NewsResponse(id = "6", title = "잭슨 피자를 시키려고 했으나 38800원이라 노모어 피자로 도망 간 슬픈 이야기. 여름이었다.", keyword = "Kotlin", letter = "Android Weekly", summary = "", url = "https://www.naver.com"),
    )
